...
const Footer = () => {
  ...
  const footerContainerLayout:string = 'w-full h-full mobile:w-full desktop:w-[1024px] flex flex-row justify-center items-center px-5';
  ...
  return (
    <div className={footerStyle.join('')}>
      <div className={footerContainerStyle.join('')}>
        <div className="flex w-[200px]"><Logo color="#cbd5e1" width={120}/></div>
        <div className="flex w-[200px] h-[50px] border-l solid text-slate-400"> 푸터입니다.</div>
      </div>
    </div>
  )
}
